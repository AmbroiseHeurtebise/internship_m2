...
def multiviewica_test2(
    ...
    W, S, tau_list = _multiview_ica_main(
        ...
        init_delay=init_delay, delay_every_iteration=delay_every_iteration, verbose=verbose,
    )
