...
bids_root = pathlib.Path(
    '/storage/store/data/camcan/BIDSsep/passive')

deriv_root = pathlib.Path('/storage/store2/work/aheurteb/mvicad/tbme/data/camcan')
...
task = 'passive'
sessions = ['passive']  # keep empty for code flow
data_type = 'meg'
ch_types = ['meg']
