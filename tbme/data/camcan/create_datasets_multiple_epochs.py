...
def keep_clean_subjects(subjects, task):
    if task == "visual":
        clean_id = [
            0, 10, 13, 15, 17, 19, 23, 24, 26, 29, 30, 35, 42, 44, 49, 50, 51, 55, 65,
            72, 81, 84, 88, 90, 93, 94, 97, 98, 102, 103, 104, 105, 106, 107, 112, 116,
            117, 125, 131, 132, 139, 141, 142, 144, 146, 150, 155, 156, 162, 163, 164,
            171, 172, 174, 177, 179, 181, 182, 188, 190, 192, 198, 201, 202, 206, 210,
            213, 219, 225, 227, 228, 230, 232, 234, 238, 248, 251, 258, 260, 262, 267,
            268, 279, 286, 291, 292, 293, 294, 302, 304, 308, 311, 322, 330, 333, 337,
            342, 343, 348, 353, 360, 361, 365, 385, 386, 395, 398, 399, 402, 403, 404,
            410, 412, 414, 424, 425, 427, 428, 431, 433, 435, 436, 449, 456, 470, 478,
            488, 489, 490, 492, 494, 505, 509, 510, 517, 521, 536, 548, 549, 555, 560,
            565, 567, 587, 588, 598, 606, 608, 613, 616]
    elif task == "auditory":
        clean_id = [
