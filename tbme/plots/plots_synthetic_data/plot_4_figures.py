...
def plot_figure_amari(
    ...
    change_xticks=None, all_lines_available=False,
):
...
save_name_1 = f"DataFrame_with_{nb_seeds_2}_seeds_wrt_n_subjects"
save_name_2 = f"DataFrame_with_{nb_seeds_2}_seeds_wrt_n_sources"
save_name_3 = f"DataFrame_with_{nb_seeds_1}_seeds_wrt_n_concat"
save_name_4 = f"DataFrame_with_{nb_seeds_1}_seeds_wrt_noise"
...
plot_figure_amari(
    ...
    font_properties=font_properties, change_xticks="all", all_lines_available=True)
plot_figure_amari(
    df_4, x="noise_data", xlabel="Noise", ax=axes[1, 1], font_properties=font_properties,
    xscale_log=True, fig=fig, all_lines_available=True)
