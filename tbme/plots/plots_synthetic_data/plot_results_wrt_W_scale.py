...
def plot_figure_amari(df, ax, font_properties):
    sns.lineplot(
...
def plot_figure_errors(df, ax, font_properties):
    sns.lineplot(
...
plt.subplot(1, 2, 1)
plot_figure_amari(df, axes[0], font_properties)
plt.subplot(1, 2, 2)
plot_figure_errors(df, axes[1], font_properties)
plt.tight_layout(pad=1.5, w_pad=4.0)
